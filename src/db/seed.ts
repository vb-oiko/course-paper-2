...
import PurchaseSkuPosSeed from "./seed/PurchaseSkuPosSeed";
import PurchaseRequestSeed from "./seed/PurchaseRequestSeed";
...
const seed = async () => {
  ...
  seeds.add(new PurchaseSkuPosSeed(db));
  seeds.add(new PurchaseSkuPosSeed(db));
  seeds.add(new PurchaseRequestSeed(db));
